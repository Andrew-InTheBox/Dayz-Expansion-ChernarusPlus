...
set "serverName=KRONJON-Cherna-PvE-AI"
::Server Port
set "serverPort=2302"
::Server config
...
if not defined SKIP_MODS set "SKIP_MODS=_@Heatmap _@KeyCardRoomsServer _@KeyCard-Rooms-VendorBackup"
...
if not defined SERVER_UPDATE_DIRS set "SERVER_UPDATE_DIRS=dta addons battleye keys sakhal bliss"
